...
export type StructureQuality = { chapterCount: number; sceneCount: number; segmentCount: number; dialogueSegmentCount: number; unresolvedDialogueCount: number; averageSegmentChars: number; longSegmentCount: number; mixedSegmentWarningCount: number; castCandidateCount: number; lowConfidenceCastCandidateCount: number; possibleSceneBreakCount: number; warningsNeedingReviewCount: number; llmRefinementUsed: boolean; llmAcceptedBatchCount: number; llmRejectedBatchCount: number };
